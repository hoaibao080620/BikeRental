...
namespace BikeBookingService.Migrations
{
    ...
    [Migration("20220720161127_AddDistaneFieldbjgjhgq5425")]
    partial class AddDistaneFieldbjgjhgq5425
    {
            ...
            modelBuilder.Entity("BikeBookingService.Models.BikeRentalBooking", b =>
                {
                    ...
                    b.Property<int>("CheckinBikeStationId")
                        .HasColumnType("integer")
                        .HasColumnName("checkin_bike_station_id");

                    b.Property<DateTime>("CheckinOn")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("checkin_on");

                    b.Property<int?>("CheckoutBikeStationId")
                        .HasColumnType("integer")
                        .HasColumnName("checkout_bike_station_id");
