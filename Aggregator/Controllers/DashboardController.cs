...
public class DashboardController : ControllerBase
{
    ...
    public DashboardController(GrpcClientFactory grpcClientFactory)
    {
        ...
        _accountServiceGrpc = grpcClientFactory.CreateClient<AccountServiceGrpc.AccountServiceGrpcClient>("BikeService");
        _bikeBookingServiceGrpc = grpcClientFactory.CreateClient<BikeBookingServiceGrpc.BikeBookingServiceGrpcClient>(
            "BikeBookingService");
    }

    [HttpGet]
    public async Task<IActionResult> GetNumberStatistics(string filterType = "week")
    {
